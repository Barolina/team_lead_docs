...
* [СУБД](СУБД/readme.md)
  ...
  * [Что нужно учитывать при работе с СУБД](СУБД/субд.md)
  ...
  * [Streaming data to  ElasticSearch/Opensearch](subd/streaming-data-to-elasticsearch-opensearch.md)
  * [Удалить  зависшую транзакцию](subd/udalit-zavisshuyu-tranzakciyu.md)
